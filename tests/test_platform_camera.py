...
Levels are wider than the panel, so what matters is that the window
follows the player without ever showing anything past the ends of the
level -- a scrolled-past edge reads as a hole in the world.
"""
